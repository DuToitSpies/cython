...
#define __Pyx_PyDict_GetItemStrWithError  DICT_GET_ITEM_WITH_ERROR
...
#else
#define __Pyx_TypeCheck(obj, type) PYOBJECT_TYPE_CHECK(obj, CAST_IF_CAPI(PyTypeObject *)type)
#define __Pyx_TypeCheck2(obj, type1, type2) (PYOBJECT_TYPE_CHECK(obj, CAST_IF_CAPI(PyTypeObject *)type1) || PYOBJECT_TYPE_CHECK(obj, CAST_IF_CAPI(PyTypeObject *)type2))
