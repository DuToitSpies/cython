...
#define __Pyx_hNewRef(obj) HPy_Dup(HPY_CONTEXT_CNAME, obj) //This will be merged into Pyx_NewRef eventually, but #if CYTHON_USING_HPY will make all calls to this macro use HPy, even if it hasn't been ported yet
